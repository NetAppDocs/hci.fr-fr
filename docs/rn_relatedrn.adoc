...
* link:rn_compute_firmware_2.179.0.html["Notes de version du pack de firmware de calcul 2.179.0"]
...
* link:rn_storage_firmware_2.182.0.html["Notes de version du pack de firmware de stockage 2.182.0"]
