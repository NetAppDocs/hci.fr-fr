...
---
= Notes de version du pack de firmware de stockage 2.164.0
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Le pack de firmware de stockage version 2.164.0 contient la prise en charge des cartes réseau Mellanox CX5 16.32.1010 et une mise à jour du firmware pour le lecteur PM9A3.
...
NOTE: Le tableau suivant indique les versions de micrologiciel de composant prises en charge dans cette version de Storage Firmware Bundle pour les modèles SF38410, SFG19210, SF9605 et SF4805. Toutefois, ces firmwares de composants ne peuvent pas être mis à jour dans le pack Storage Firmware.
